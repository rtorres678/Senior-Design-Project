...
option6 = os.path.join(cwd, 'sf2', 'JR_strings.sf2')
...
current_sound_static = Label(window, text='Current Sound', font=('monospace', 56))
current_track = Label(window, text=soundfonts[current[0]].split('/')[-1].split('_')[-1].split('.')[0].title().center(10), font=("monospace", 56))
...
back_arrow_btn.grid(row=2, column=0, padx=(25,150))
