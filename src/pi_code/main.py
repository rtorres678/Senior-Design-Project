...
#            self.rect = Rectangle(source = 'images/harp.jpg', pos = self.center)
        ...
        self.current_sound_static = Label(text = '[b]CURRENT SOUND[/b]', markup = True, font_size = 65, font_name = 'HelveticaNeue', italic = True, outline_color = (22,126,245))
        ...
        self.current_preset = Label(text = soundfonts[current[0]].split('/')[-1].split('.')[0].replace('_', ' '), markup = True, font_size = 50, font_name = ("HelveticaNeue"))
...
#        prev_preset = Button(size_hint = (None, None), height = int(Window.height) / 4, background_normal = ('images/leftarrow-v2.png'), background_down = ('images/leftarrowdown-v3.png'))
        prev_preset = Button(text = '[b]PREVIOUS SOUND[/b]', markup = True, size_hint=(1.5, None), font_size = 25, pos_hint={'center_x': .5, 'center_y': .5})
        ...
        self.inside2.add_widget(Label(text = '[b]VOLUME[/b]', markup = True, font_size = 30, font_name = 'HelveticaNeue'))
        ...
        self.inside2.add_widget(Label(text = '[b]REVERB[/b]', markup = True, font_size = 30, font_name = 'HelveticaNeue'))
        ...
        self.inside2.add_widget(Label(text = '[b]CHORUS[/b]', markup = True, font_size = 30, font_name = 'HelveticaNeue'))
...
#        next_preset = Button(size_hint = (None, None), height = int(Window.height) / 4, background_normal = ('images/rightarrow-v2.png'), background_down = ('images/rightarrowdown-v2.png'))
        next_preset = Button(text = '[b]NEXT SOUND[/b]', markup = True, font_size = 25, size_hint=(1.5, None), pos_hint={'center_x': .5, 'center_y': .5})
